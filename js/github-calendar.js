  ...
  })()(
    {
      1: [
        function (require, module, exports) {
           ...
           */
          module.exports = function GitHubCalendar(
            container,
            username,
            options
          ) {
                    ...
                    if (options.global_stats !== false) {
                      var parsed = parse($('svg', cal).outerHTML),
                        currentStreakInfo = parsed.current_streak
                          ...
                          ? 'Last contributed in ' +
                            formatoid(parsed.last_contributed, DATE_FORMAT2) +
                            '.'
                          : 'Rock - Hard Place',
                        ...
                        firstCol = $('<div>', {
                          ...
                          html:
                            ...
                            formatoid(
                              addSubtractDate.add(
                                addSubtractDate.subtract(new Date(), 1, 'year'),
                                1,
                                'day'
                              ),
                              DATE_FORMAT1
                            ...
                            ' &ndash; ' +
                            formatoid(new Date(), DATE_FORMAT1) +
                            '</span>',
                        }),
                        secondCol = $('<div>', {
                          ...
                          html:
                            ...
                            printDayCount(parsed.longest_streak) +
                            '</span>\n                               <span class="text-muted">' +
                            longestStreakInfo +
                            '</span>',
                        }),
                        thirdCol = $('<div>', {
                          ...
                          html:
                            ...
                            printDayCount(parsed.current_streak) +
                            '</span>\n                               <span class="text-muted">' +
                            currentStreakInfo +
                            '</span>',
                        })
        ...
        function (require, module, exports) {
          ...
          var ParseIt = (function () {
            ...
            function ParseIt(obj) {
              ...
              this.obj = obj || {}
              this.re = new RegExp(
                '^(' + Object.keys(obj).map(regexEscape).join('|') + ')'
              )
            }
